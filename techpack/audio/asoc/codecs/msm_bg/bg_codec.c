...
static void bg_cdc_pktzr_init(struct work_struct *work)
{
	...
	queue_delayed_work(system_power_efficient_wq,system_power_efficient_wq,&bg_cdc->bg_cdc_cal_init_work,
...
{
	ueue_delayed_work(system_power_efficient_wq,&bg_cdc->bg_cdc_pktzr_init_work,
			msecs_to_jiffies(0));
	return 0;
}
